  ...
  <el-container>
    <el-main>
      ...
      <el-form :model="IdentityFrom" :rules="rules" ref="userIndex">
        <el-form-item prop="userIndex">
          <el-input
              v-model="IdentityFrom.userIndex"
              placeholder="请输入管理员提供的教师编号"
          >
          </el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        userIndex: [
          {required: true, message: "教师编号不得为空!", trigger: "blur"},
        ],
      },
    };
  },
  created() {
    ...
    this.$notify({
      title: "提示",
      message: "教师编号来自管理员，如有需要，请联系管理员提供!",
      type: "warning",
    });
  },
  methods: {
